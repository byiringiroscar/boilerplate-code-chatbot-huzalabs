...
# postgres:
app.config[
    'SQLALCHEMY_DATABASE_URI'] = "postgresql+psycopg2://admin:54DLw1JZhDqX2CukcET0SYTtp5TDagr8@dpg-cf3ad3sgqg45ccsmkem0-a.oregon-postgres.render.com/chatbot_db_akr8"
db = SQLAlchemy(app)
...
def process(QUESTION: str):
    Q.append(QUESTION)
    USER_QUERY, SL = process_question(
        QUESTION)  # Translate the original question into english and store the source lang
